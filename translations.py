...
own song but don't know how? Check out docs/SONGS.md in the source code to learn how to add your own songs.""".replace(
        ...
        'camera-mode-dropdown': ["Center", "Lazy", "Smoothed (Default)", "Predictive"],
        'song-by': 'Song by',
        'mapper-text':'Mapped by',
        'on': 'On',
        'off': 'Off',
        "rng-seed": "RNG seed",
        "rng-seed-placeholder": "Default is random number",
        "starting-time-delay": "Starting time delay",
        "max-notes-to-generate": "Max notes to generate",
        'max-notes-to-generate-placeholder': "Default is infinity",
        'reset-button-placeholder': 'Reset to default',
...
Kolla docs/SONGS.md i källkoden för att lära dig hur du lägger till dina egna låtar.""".replace("\n", ''),
    ...
    "open-songs-folder": "Otevřít složku s písněmi",
    "quit": "Ukončit",
